...
const DailyAttendance = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post(`${import.meta.env.VITE_SERVER}/attendance`, { employeeId: selectedEmployee._id, date, status, workDone })
      .then(response => {
            ...
            >
              ...
              >
                ...
                <motion.div 
                  ...
                  className="mb-6"
                >
                  <label className="block text-gray-700 text-sm font-bold mb-2">Work Done Today</label>
                  <textarea
                    value={workDone}
